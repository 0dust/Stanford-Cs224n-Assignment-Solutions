...
class RNNModel(NERModel):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE (~4-6 lines)
        embedding_tensor = tf.Variable(self.pretrained_embeddings,'embedding')
    ...
    def add_prediction_op(self):
        ...
        b_2 = tf.get_variable('b2',shape = (Config.n_classes,),initializer = tf.constant_initializer())
